...
import magicdraw.Configuration;
import magicdraw.MDModelLibException;
import magicdraw.MDSysMLModelHandler;
...
public class MagicDrawManager {
	...
	public static String magicdrawModelsDirectory = Configuration.magicdrawModelsDirectory;
	...
	public static String baseHTTPURI = "http://localhost:" + Configuration.portNumber + "/oslc4jmagicdraw";
...
//			if (Configuration.useIndividualSubversionFiles) {
...
//			public void start() {
				...
				ArrayList<File> files = getMagicDrawModels(Configuration.magicdrawModelsDirectory,
						new ArrayList<File>());
				for (File file : files) {
